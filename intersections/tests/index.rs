...
fn test_split_cubic_bezier() {
    let bez = [
        106.13448333740234, 52.76838684082031, -115.86551666259766, -44.73158264160156,
        83.74869728088379, 102.76840209960938, 56.13446044921875, 102.76840209960938,
    ];
    let t = 0.3;
    let (left, right) = intersections::split_cubic_bezier(&bez, t);
    const TEST_RES: [f64; 8] = [
        106.13448333740234, 52.76838684082031, 39.534483337402335, 23.518395996093748,
        10.879762592315668, 16.31840103149414, 2.6515691547393763, 20.5709035949707,
    ];
    assert!(float_arrays_equal(&left, &TEST_RES));

    const TEST_RES_2: [f64; 8] = [
        2.6515691547393763, 20.5709035949707, -16.54754886627197, 30.493409576416017,
        75.46442623138427, 102.76840209960938, 56.13446044921875, 102.76840209960938,
    ];
...
fn test_split_cubic_bezier_part() {
    ...
    const TEST_RES: [f64; 8] = [
        2.6515691547393763, 20.5709035949707, -11.062086574554444, 27.65840786743164,
        31.964611328125002, 66.5584052734375, 50.62632977294923, 88.20840344238283,
    ];
...
fn test_line_intersection() {
    ...
    const TEST_RES: [[f64; 6]; 5] = [
        [-1.0, 48.26337652675305, 36.14526629053258, -1.0, 48.26337652675305, 36.14526629053258],
        [-1.0, 43.22701149425287, 17.5, -1.0, 43.22701149425287, 17.5],
        [
            -1.0, 52.101279505846016, 50.353673064195895, -1.0, 52.101279505846016, 50.353673064195895,
        ],
        [-1.0, 56.40765424805228, 66.29642210981058, -1.0, 56.40765424805228, 66.29642210981058],
        [-1.0, 38.58552846591281, 41.831002026276224, -1.0, 38.58552846591281, 41.831002026276224],
    ];
